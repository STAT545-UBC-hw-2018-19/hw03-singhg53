...
set the trim to 0.16, it will cut off 16% of the data from the bootom
and top of the data. Interestingly, this would mean that it would
represent one standard if the trim is set to 0.16.
...
```
    ...
    ##   <fct>     <dbl>        <dbl>             <dbl>         <dbl>
    ## 1 Africa     48.9         50.6              48.2          47.8
    ## 2 Americas   64.7         69.5              65.7          67.0
    ## 3 Asia       60.1         61.1              60.8          61.8
